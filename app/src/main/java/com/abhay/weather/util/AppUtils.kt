...
fun showMoreOptions (context: Context) {
    ...
    share.setOnClickListener {
        Utils.share(context,context.getString(R.string.app_name),"Hey! You must try this amazing Weather Zone App: $storeLink","Share Now Via")
        dialog.dismiss()
    }
    feedback.setOnClickListener {
        Utils.feedback(context,context.getString(R.string.app_email),
