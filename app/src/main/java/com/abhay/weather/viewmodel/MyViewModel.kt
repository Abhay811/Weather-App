package com.abhay.weather.viewmodel

import android.util.Log
import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import com.abhay.weather.data.models.*
...
import com.abhay.weather.util.Resource
import com.abhay.weather.util.error
import com.abhay.weather.util.info
...
class MyViewModel : ViewModel() {
     ...
     * City by query call
     */
    fun getCityByQuery(model: CityRepository,query:String) = viewModelScope.launch {
        safeCityByQueryFetch(model,query) }
